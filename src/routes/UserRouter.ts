...
UserRouter.route('/perfil').get(UserController.getUserPerfil);
UserRouter.route('/create').post([authRol],UserController.createUser);
UserRouter.route('/register').post(UserController.register);
UserRouter.route('/').get([authRol],UserController.getUsers);
UserRouter.route('/:id').get([authRol],UserController.getUserById);
